 ...
 */
#define CONFIG_SYS_PROMPT				"ap700a#"		/* Monitor Command Prompt   */
...
#define CONFIG_ENV_IS_IN_MMC
	...
	#define CONFIG_MMC1_ATTACH		TRUE	/* 1 = MMC1 : Control Box SD */
	#define CONFIG_MMC2_ATTACH		TRUE	/* 2 = MMC2 : Internal SD */
