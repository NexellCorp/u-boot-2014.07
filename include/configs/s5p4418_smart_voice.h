...
#define	CONFIG_CMD_I2C
    ...
    #define CFG_IO_I2C0_SCL					((PAD_GPIO_E + 9) | PAD_FUNC_ALT0)	// AP_GPE9_PMIC_SCL
    #define CFG_IO_I2C0_SDA					((PAD_GPIO_E + 8) | PAD_FUNC_ALT0)	// AP_GPE8_PMIC_SDA
...
#define	CONFIG_RECOVERY_BOOT
    ...
    #define CONFIG_CMD_RECOVERY_BOOT "setenv bootargs console=ttyAMA3,115200n8 androidboot.hardware=s5p4418_smart_voice androidboot.console=ttyAMA3 androidboot.serialno=12345 initrd=0x49000000,0x200000 init=/init;ext4load mmc 0:1 0x48000000 uImage;ext4load mmc 0:1 0x49000000 ramdisk-recovery.img;bootm 0x48000000"
#endif
