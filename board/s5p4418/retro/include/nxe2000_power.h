...
#define	NXE2000_DEF_LDO4_ON					0		/* VAL = 0: Off, 1: On */	/* 1.9V SYS,		Boot On	*/
...
#define	NXE2000_DEF_LDO9_ON					1		/* VAL = 0: Off, 1: On */	/* 3.3V none,	Not Use	*/
...
#define	NXE2000_DEF_LDO1_VOL				1100000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
#define	NXE2000_DEF_LDO2_VOL				1200000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 1.80V */
...
#define	NXE2000_DEF_LDO5_VOL				1800000	/* VAL(uV) = 0: 0.60 ~ 3.5V, Step = 25mV, default(OTP) = 2.80V */
...
#define	NXE2000_DEF_LDO8_VOL				2500000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
#define	NXE2000_DEF_LDO9_VOL				3300000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
#define	NXE2000_DEF_LDO10_VOL				3300000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 1.20V */
...
#define	NXE2000_DEF_LDO1_SLP_VOL			1100000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
#define	NXE2000_DEF_LDO2_SLP_VOL			1200000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 1.80V */
...
#define	NXE2000_DEF_LDO5_SLP_VOL			1800000	/* VAL(uV) = 0: 0.60 ~ 3.5V, Step = 25mV, default(OTP) = 2.80V */
...
#define	NXE2000_DEF_LDO8_SLP_VOL			2500000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
#define	NXE2000_DEF_LDO9_SLP_VOL			3300000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 3.30V */
#define	NXE2000_DEF_LDO10_SLP_VOL			3300000	/* VAL(uV) = 0: 0.90 ~ 3.5V, Step = 25mV, default(OTP) = 1.20V */
