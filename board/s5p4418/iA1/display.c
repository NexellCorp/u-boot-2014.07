...
#if defined(CONFIG_DISPLAY_OUT_HDMI)
	int preset = V4L2_DV_720P60;

	if ((multily.x_resol == 1920) && (multily.y_resol == 1080))
		preset = V4L2_DV_1080P60;
	else if ((multily.x_resol == 1280) && (multily.y_resol == 720))
		preset = V4L2_DV_720P60;
	else if ((multily.x_resol == 720) && (multily.y_resol == 576))
