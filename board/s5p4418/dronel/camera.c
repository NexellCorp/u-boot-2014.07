...
#if 1
static const struct reg_val _sensor_init_data[] =
{
	{0xfd,0x00},
...
//	{0x31,0x10},//mirror upside down
	...
	#if 0
	///SP2518 UXGA 24MEclk 3鍊嶉 1鍒嗛 50Hz fix 11fps
	{0xfd , 0x00},
	{0x03 , 0x03},
	{0x04 , 0xa8},
	{0x05 , 0x00},
...
#if 1
	#if 1
	///SP2518 UXGA 24MEclk 3鍊嶉 1鍒嗛 50Hz fix 10fps
	{0xfd , 0x00},
	{0x03 , 0x03},
	{0x04 , 0x0C}, //K 66
	{0x05 , 0x00},
	...
	#if 0
	/// UXGA 24MEclk 3鍊嶉 1鍒嗛 50Hz fix 9fps
	{0xfd , 0x00},
	{0x03 , 0x03},
	{0x04 , 0x42},
	{0x05 , 0x00},
	...
	{0xda , 0x00},
	{0xensor_setup_io] ---
[_sensor_power_enable] enable : 1
+++ [_sensor_power_enable] +++
d , 0x00},
	#endif
...
static void camera_power_control(int enable)
{
	...
	if( enable )
		...
		axp228_i2c_set_bits(&power, AXP22_LDO_DC_EN2, 0<<AXP_DLDO2_EN_BIT);
...
static void io_status(const char *io_name, int io, int cnt)
{
	int value=0;
	int i=0;
