...
#define CONFIG_SYS_MEMTEST_END			((CONFIG_SYS_SDRAM_BASE + CONFIG_SYS_SDRAM_SIZE) - 0x1)
...
#define CONFIG_BOOTCOMMAND 				"mmc dev 0;mmc read 48000000 800 2800; mmc read 49000000 3800 5000; bootm 48000000"

/*-----------------------------------------------------------------------
 * Miscellaneous configurable options
 */
#define CONFIG_SYS_PROMPT				"ktws# "	/* Monitor Command Prompt */
...
#define CONFIG_ENV_IS_IN_MMC
	...
	#define CONFIG_MMC1_ATTACH			TRUE	/* 1 = MMC1 : SDIO */
	#define CONFIG_MMC2_ATTACH			FALSE	/* 2 = MMC2 : Not used */
...
#define	FASTBOOT_PARTS_DEFAULT		\
			...
			"flash=mmc,0:ramdisk:raw:0x700000,0x1000000;" \
			"flash=mmc,0:userdata:ext4:0x1700000,0x0;"
#endif
