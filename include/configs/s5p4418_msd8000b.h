...
#define CONFIG_PMIC
		...
		#define	CFG_IO_I2C3_SCL	((PAD_GPIO_C + 15))
		#define	CFG_IO_I2C3_SDA	((PAD_GPIO_C + 16))
...
#define	CONFIG_RECOVERY_BOOT
    ...
    #define CONFIG_CMD_RECOVERY_BOOT "setenv bootargs console=ttyAMA0,115200n8 androidboot.hardware=s5p4418_msd8000b androidboot.console=ttyAMA0 androidboot.serialno=12345 initrd=0x49000000,0x200000 init=/init;ext4load mmc 2:1 0x48000000 uImage;ext4load mmc 2:1 0x49000000 ramdisk-recovery.img;bootm 0x48000000"
#endif
