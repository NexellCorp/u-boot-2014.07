 ...
 */
#define CONFIG_SYS_PROMPT				"retro# "     										/* Monitor Command Prompt   */
...
//#define CONFIG_ENV_IS_IN_EEPROM
 		...
 		#define CONFIG_SPI0_TYPE				0 /* 1: EEPROM, 0: SPI device */
 ...
 */
        ...
        #define CONFIG_SPI_MODULE_1_EEPROM          CONFIG_SPI0_TYPE    /* 1: EEPROM, 0: SPI device */
    #endif
        ...
        #define CONFIG_SPI_MODULE_2_EEPROM          CONFIG_SPI0_TYPE    /* 1: EEPROM, 0: SPI device */
    #endif
#endif
...
#define CONFIG_PMIC
		...
		#define	CFG_IO_I2C0_SCL	((PAD_GPIO_E + 9) | PAD_FUNC_ALT0)
		#define	CFG_IO_I2C0_SDA	((PAD_GPIO_E + 8) | PAD_FUNC_ALT0)
