...
#define CONFIG_BOOTCOMMAND "mmc dev 0;mmc read 0x46000000 0x1000 0x5000;bootm 0x46000000"
...
#define	CONFIG_CMD_I2C
    ...
    #define CFG_IO_I2C0_SCL					(PAD_GPIO_E + 9)	// AP_GPE9_PMIC_SCL
    #define CFG_IO_I2C0_SDA					(PAD_GPIO_E + 8)	// AP_GPE8_PMIC_SDA
...
#define CONFIG_ENV_IS_IN_MMC
	...
	#define CONFIG_MMC0_CLOCK			40000000
...
#define	FASTBOOT_PARTS_DEFAULT		\
			...
			"flash=mmc,0:ramdisk:ext4:0x3000000,0x2000000;"	\
...
#define	CONFIG_RECOVERY_BOOT
	...
	#define CONFIG_CMD_RECOVERY_BOOT "ext4load mmc 0:1 0x46000000 uImage;ext4load mmc 0:1 0x49000000 ramdisk-recovery.img;bootm 0x46000000"
#endif

#define        CONFIG_UPDATE_BOOT
#if defined (CONFIG_UPDATE_BOOT)
    #define CONFIG_CMD_UPDATE_BOOT "setenv bootargs console=ttyAMA0,115200n8 root=/dev/ram0 rw initrd=0x49000000,32M ramdisk=32768;ext4load mmc 0:1 0x46000000 uImage_update;ext4load mmc 0:1 0x49000000 ramdisk_update.gz;bootm 0x46000000"
#endif
 ...
 */
#define	CONFIG_PWM
#define CONFIG_NXC100_DOWNLOAD
#define CONFIG_UART_CHANNEL_NXC100		2
