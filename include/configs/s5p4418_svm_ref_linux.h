...
#define	CONFIG_PLAT_S5P4418_SVM_REF
...
//#define CONFIG_BOOTCOMMAND "mmc dev 0;mmc read 48000000 800 2800; mmc read 49000000 3800 18000"
...
#define CONFIG_PMIC
		...
		#define CONFIG_PMIC_I2C_BUS							I2C_4
...
#define	CONFIG_CMD_I2C
    ...
    #define CFG_IO_I2C0_SCL					((PAD_GPIO_A + 17) | PAD_FUNC_ALT0)	// AP_GPA17_DTVSCL
    #define CFG_IO_I2C0_SDA					((PAD_GPIO_A + 18) | PAD_FUNC_ALT0)	// AP_GPA18_DTVSDA

    #define CFG_IO_I2C1_SCL					((PAD_GPIO_B + 18) | PAD_FUNC_ALT2)	// AP_GPB18_AUDIOSCL
    #define CFG_IO_I2C1_SDA					((PAD_GPIO_B + 16) | PAD_FUNC_ALT2)	// AP_GPB16_AUDIOSDA

    #define CFG_IO_I2C2_SCL					((PAD_GPIO_C + 1) | PAD_FUNC_ALT1)	// AP_GPC1_SECSCL
    #define CFG_IO_I2C2_SDA					((PAD_GPIO_C + 2) | PAD_FUNC_ALT1)	// AP_GPC2_SECSDA

    #define CFG_IO_I2C3_SCL					((PAD_GPIO_C + 25) | PAD_FUNC_ALT1)	// AP_GPC25_ADV7391_HUBSCL
    #define CFG_IO_I2C3_SDA					((PAD_GPIO_C + 27) | PAD_FUNC_ALT1)	// AP_GPC27_ADV7391_HUBSDA

    #define CFG_IO_I2C4_SCL					((PAD_GPIO_D + 4) | PAD_FUNC_ALT0)	// AP_GPD4_PMIC_SCL
    #define CFG_IO_I2C4_SDA					((PAD_GPIO_D + 5) | PAD_FUNC_ALT0)	// AP_GPD5_PMIC_SDA

    #define CFG_IO_I2C5_SCL					((PAD_GPIO_D + 6) | PAD_FUNC_ALT1)	// AP_GPD6_TOUCHSCL
    #define CFG_IO_I2C5_SDA					((PAD_GPIO_D + 7) | PAD_FUNC_ALT1)	// AP_GPD7_TOUCHSDA

    #define CFG_IO_I2C6_SCL					((PAD_GPIO_D + 29) | PAD_FUNC_ALT0)	// AP_GPD29_HMO_SCL
    #define CFG_IO_I2C6_SDA					((PAD_GPIO_D + 30) | PAD_FUNC_ALT0)	// AP_GPD30_HMO_SDA

    #define CFG_IO_I2C7_SCL					((PAD_GPIO_E + 4) | PAD_FUNC_ALT0)	// AP_GSML_SCL
    #define CFG_IO_I2C7_SDA					((PAD_GPIO_E + 3) | PAD_FUNC_ALT0)	// AP_GSML_SDA
...
//#define	CONFIG_RECOVERY_BOOT
    ...
    #define CONFIG_CMD_RECOVERY_BOOT "setenv bootargs console=ttyAMA3,115200n8 androidboot.hardware=s5p4418_svm_ref androidboot.console=ttyAMA3 androidboot.serialno=12345 initrd=0x49000000,0x200000 init=/init;ext4load mmc 0:1 0x48000000 uImage;ext4load mmc 0:1 0x49000000 ramdisk-recovery.img;bootm 0x48000000"
#endif
