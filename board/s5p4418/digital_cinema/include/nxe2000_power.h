...
#define NXE2000_DEF_LIMIT_ADP_AMP			1000000	/* VAL(mA), MAX = 2500mA */
...
#define	NXE2000_DEF_LDO1_ON					0		/* VAL = 0: Off, 1: On */	/* 3.3V GPS & WIFI	Not Use */
#define	NXE2000_DEF_LDO2_ON					0		/* VAL = 0: Off, 1: On */	/* 1.8V CAM1	Not Use */
...
#define	NXE2000_DEF_LDO5_ON					0		/* VAL = 0: Off, 1: On */	/* 2.8V CAM		Not Use */
#define	NXE2000_DEF_LDO6_ON					1		/* VAL = 0: Off, 1: On */	/* 3.3V ALIVE,	Boot On	*/
#define	NXE2000_DEF_LDO7_ON					0		/* VAL = 0: Off, 1: On */	/* 2.8V VID,	Not USe	*/
...
#define	NXE2000_DEF_LDO10_ON				1		/* VAL = 0: Off, 1: On */	/* 1.2V none,	Boot On	*/
...
#define NXE2000_DEF_CHG_USB_EN				0		/* VAL = 0: Off, 		1: On, 	default = On */
...
#define NXE2000_DEF_CHG_ADP_EN				0		/* VAL = 0: Off, 		1: On, 	default = On */
#endif
