 ...
 */
#define CONFIG_SYS_PROMPT				"s5p6818-iQSFv# "     									/* Monitor Command Prompt   */
...
#define	CONFIG_RECOVERY_BOOT
	...
	#define CONFIG_CMD_RECOVERY_BOOT "setenv bootargs initrd=0x49000000,0x300000 console=ttySAC0,115200n8 androidboot.hardware=iQSFv androidboot.console=ttySAC0 androidboot.serialno=0123456789abcdef init=/init;ext4load mmc 2:1 0x48000000 uImage;ext4load mmc 2:1 0x49000000 ramdisk-recovery.img;bootm 0x48000000"
#endif
...
//#define CONFIG_BOOT_LOGO_ENABLE
//#define CONFIG_BOOT_DELAY_ENABLE
