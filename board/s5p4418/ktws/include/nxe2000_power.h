...
#define	NXE2000_DEF_DDC1_VOL				1075000	/* VAL(uV) = 0: 0.60 ~ 3.5V, Step 12.5 mV, default(OTP) = 1.3V */
...
#define	NXE2000_DEF_DDC1_SLP_VOL			1075000	/* VAL(uV) = 0: 0.60 ~ 3.5V, Step 12.5 mV, default(OTP) = 1.3V */
