...
#define	CONFIG_CMD_I2C
    ...
    #define CFG_IO_I2C5_SCL					((PAD_GPIO_D + 22) | PAD_FUNC_ALT0)	// AP_GPD22_HMO_SCL
    #define CFG_IO_I2C5_SDA					((PAD_GPIO_D + 23) | PAD_FUNC_ALT0)	// AP_GPD23_HMO_SDA

    #define CFG_IO_I2C6_SCL					((PAD_GPIO_D + 26) | PAD_FUNC_ALT0)	// AP_GPD26_DESSCL
    #define CFG_IO_I2C6_SDA					((PAD_GPIO_D + 27) | PAD_FUNC_ALT0)	// AP_GPD27_DESSDA
...
#define	FASTBOOT_PARTS_DEFAULT		\
			...
			"flash=mmc,2:kernel:raw:0x100000,0x500000" \
			"flash=mmc,2:ramdisk:raw:0x700000,0x3000000;" \
			"flash=mmc,2:userdata:ext4:0x3700000,0x0;"
#endif
